...
export const metadata = {
  ...
  keywords: ["frequency healer", "sound healing", "Deepalli Sharma", "Chintan Chikitsa", "holistic healing", "energy healing"],
  authors: [{ name: "Deepalli Sharma" }],
  robots: { index: true, follow: true },
  openGraph: {
    title: "Chintan Chikitsa | Deepalli Sharma – Frequency Healer",
    description: "Holistic healing through frequency and sound. Book a free discovery call with Deepalli Sharma.",
